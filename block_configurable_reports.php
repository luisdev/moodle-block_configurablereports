...
$string['showrecordcount'] = "Show Total record count";
$string['showrecordcountinfo'] = "Show the Total record count on the View Report page. This is probably only useful when debugging so it is probably best to leave it off. Students do not need to see technical information about the report records.";
// LUIS: Add lastexecutiontime setting to show/hide the "Show Execution time" option
$string['showexecutiontime'] = "Show the Execution time";
$string['showexecutiontimeinfo'] = "Show the query execution time on the View Report page. This is probably only useful when debugging so it is probably best to leave it off. Students do not need to see technical information about the report execution times.";
